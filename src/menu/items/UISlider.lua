...
local SettingsSlider = {
    ...
    Slider = { X = 300, Y = 14.5, Width = 75, Height = 7 },
    Divider = { X = 363.5, Y = 9, Width = 2.5, Height = 18 },
    LeftArrow = { Dictionary = "commonmenu", Texture = "arrowleft", X = 245, Y = 12.5, Width = 0, Height = 0 },
    RightArrow = { Dictionary = "commonmenu", Texture = "arrowright", X = 410, Y = 12.5, Width = 0, Height = 0 },
}
