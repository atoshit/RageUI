...
function Panels:BoutonPanel(LeftText, RightText, Index)
    ...
    if CurrentMenu ~= nil then
        ...
        if CurrentMenu and (CurrentMenu.Index == Index) then
            RenderSprite("commonmenu", "gradient_bgd", CurrentMenu.X, CurrentMenu.Y + TextPanels.Background.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset + (RageUI.StatisticPanelCount * 42), TextPanels.Background.Width + CurrentMenu.WidthOffset, TextPanels.Background.Height, 0, 255, 255, 255, 200)
